...
using ResolutionDetectorPlugin.Code;
using System.Text.Json;

namespace ResolutionDetectorPlugin
{
    internal class ResolutionDetectorPlugin : IResolutionDetectorPlugin
    {
        private AsyncTimerService _timer;
        public ResolutionDetector ResolutionDetector { get; set; } = new ResolutionDetector();
        public StoreCfgJson StoreCfgJson { get; set; } = new StoreCfgJson();

        public string Name => "ResolutionDetectorPlugin";
