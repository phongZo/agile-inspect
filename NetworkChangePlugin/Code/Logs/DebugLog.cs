    ...
    public static class DebugLog
    {
        ...
        public static void Init()
        {
            try
            {
                ...
                Filestream = new FileStream(Folder + "networkchangelog.txt", FileMode.OpenOrCreate, FileAccess.ReadWrite);
        ...
        public static void Write(string message, bool timestamp = true)
        {
            try
            {
                ...
                Permission.Instance.ResetPermissionOfFile(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\AgileInspect\\" + "networkchangelog.txt");
