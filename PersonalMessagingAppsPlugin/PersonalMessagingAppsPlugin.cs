...
{
    public class PersonalMessagingAppsPlugin : IPersonalMessagingAppsPlugin
    {
        private AsyncTimerService _timerService;
        public StoreCfgJson StoreCfgJson { get; set; } = new StoreCfgJson();
        public PersonalMessagingAppsDetector PersonalMessagingAppsDetector { get; set; } = new PersonalMessagingAppsDetector();
        public string pluginName => "PersonalMessagingAppsPlugin";
        ...
        public void Start()
        {
            ...
            {
                PluginContext.Log(pluginName, $"[PersonalMessagingApps] Unsupported triggerType '{triggerType}', plugin will not start.");
            }
        }
        ...
        {
            PluginContext.Log(pluginName, "[PersonalMessagingApps] interval hit");
            try
            {
                await Task.Run(() => PersonalMessagingAppsDetector.Instance.Check());
            }
            catch (Exception ex)
            {
