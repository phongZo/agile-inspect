...
{
    public class UsbDevicePlugin : IUsbDevicePlugin
    {
        private AsyncTimerService _timerService;
        public StoreCfgJson StoreCfgJson { get; set; } = new StoreCfgJson();
        public UsbDeviceDetector UsbDeviceDetector { get; set; } = new UsbDeviceDetector();
        public string pluginName => "UsbDevicePlugin";
        ...
        public void Start()
        {
            ...
            {
                PluginContext.Log(pluginName, $"[UsbDevice] Unsupported triggerType '{triggerType}', plugin will not start.");
            }
        }
        ...
        {
            PluginContext.Log(pluginName, "[UsbDevice] interval hit");
            try
            {
                await Task.Run(() => UsbDeviceDetector.Instance.Check());
            }
            catch (Exception ex)
            {
