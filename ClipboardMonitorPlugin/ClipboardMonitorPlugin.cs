...
namespace ClipboardMonitorPlugin
{
    public class ClipboardMonitorPlugin : IClipboardMonitorPlugin
    {
        ...
        public string Name => "ClipboardMonitorPlugin";
        ...
        public void Start()
        {
            ...
            {
                PluginContext.Log(Name, $"[ClipboardMonitor] Unsupported triggerType '{triggerType}', plugin will not start.");
                return;
            }
        }
        ...
        {
            PluginContext.Log(Name, "[ClipboardMonitor] interval hit");
            try
            {
