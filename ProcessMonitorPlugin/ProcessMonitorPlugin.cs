...
using ProcessMonitorPlugin.Code;
using System.Text.Json;

namespace ProcessMonitorPlugin
{
    public class ProcessMonitorPlugin : IProcessMonitorPlugin
    {
        private AsyncTimerService _timer;
        public ProcessMonitor ProcessMonitor { get; set; } = new ProcessMonitor();
        public StoreCfgJson StoreCfgJson { get; set; } = new StoreCfgJson();

        public string Name => "ProcessMonitorPlugin";
        ...
        private async Task CheckServiceTimersAsync()
        {
            ...
            await Task.Run(() => ProcessMonitor.Instance.CheckServices());
        }
