...
using InputMonitorPlugin.Code;
using System.Text.Json;

namespace InputMonitorPlugin
{
    internal class InputMonitorPlugin : IInputMonitorPlugin
    {
        private AsyncTimerService _timer;
        public InputMonitor InputMonitor { get; set; } = new InputMonitor();
        public StoreCfgJson StoreCfgJson { get; set; } = new StoreCfgJson();

        public string Name => "InputMonitorPlugin";
        ...
        private async Task CheckServiceTimersAsync()
        {
            ...
            await Task.Run(() => InputMonitor.Instance.CheckServices());
        }
    }
}
