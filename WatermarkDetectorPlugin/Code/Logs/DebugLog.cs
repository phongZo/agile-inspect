    ...
    public static class DebugLog
    {
        ...
        public static void Init()
        {
            try
            {
                ...
                Filestream = new FileStream(Path.Combine(folder, "watermarkdetectorlog.txt"), FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.Read);
        ...
        public static void Write(string message, bool timestamp = true)
        {
            ...
            lock (_lock)
            {
                try
                {
                    ...
                    Permission.Instance.ResetPermissionOfFile(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AgileInspect", "watermarkdetectorlog.txt"));
