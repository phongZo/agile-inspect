...
{
    public class ExternalDiskDetectorPlugin : IExternalDiskDetectorPlugin
    {
        ...
        public void Start()
        {
            ...
            {
                _externalDiskTimerService = new AsyncTimerService(interval * 1000, CheckExternalDiskTimerCallbackAsync);
                _externalDiskTimerService.Start();
            }
            else if (triggerType.Equals("Realtime", StringComparison.OrdinalIgnoreCase))
            {
                ExternalDiskDetector.Instance.StartWatcher();
            }
            else
            {
        ...
        public void Stop()
        {
            ...
            ExternalDiskDetector.Instance.StopWatcher();
        }
